...
all: guide174ao talk_server img tt sky
...
sky: talk.cpp ./skyx_tcp/skyx.cpp util.cpp ./tinyobj/tinystr.cpp.o ./tinyobj/tinyxmlparser.cpp.o ./tinyobj/tinyxml.cpp.o ./tinyobj/tinyxmlerror.cpp.o
	$(CC) -march=native -O3 ./skyx_tcp/skyx.cpp ./skyx_tcp/sky_ip.cpp $(TINY) -o sky $(CFLAGS)  $(OPENCV) -lASICamera
...
ttx: talk.cpp ttx.cpp util.cpp ./tinyobj/tinystr.cpp.o ./tinyobj/tinyxmlparser.cpp.o ./tinyobj/tinyxml.cpp.o ./tinyobj/tinyxmlerror.cpp.o
	$(CC) -march=native -O3 ttx.cpp  ao.cpp util.cpp ~/skyx_tcp/skyx.cpp ~/skyx_tcp/sky_ip.cpp $(TINY) -o ttx $(CFLAGS)  $(OPENCV) -lASICamera
